...
GOFLAGS=-ldflags "-X github.com/shootingclub/device-sdk-go.Version=$(VERSION)" -trimpath -mod=readonly
CGOFLAGS=-ldflags "-linkmode=external -X github.com/shootingclub/device-sdk-go.Version=$(VERSION)" -trimpath -mod=readonly -buildmode=pie
GOTESTFLAGS?=-race
