...
GOFLAGS=-ldflags "-X git.dev.tengwanweigu.com/common/device-sdk-go.git.Version=$(VERSION)" -trimpath -mod=readonly
CGOFLAGS=-ldflags "-linkmode=external -X git.dev.tengwanweigu.com/common/device-sdk-go.git.Version=$(VERSION)" -trimpath -mod=readonly -buildmode=pie
GOTESTFLAGS?=-race
